case "BIS_CO": {
	if (!(_taskExists)) then {
		[_taskID,"regroup"] call bis_fnc_taskSetType;
...
case "BIS_heli": {
	if (!(_taskExists)) then {
		[_taskID,"heli"] call bis_fnc_taskSetType;
...
case "BIS_report": {
	if (!(_taskExists)) then {
		[_taskID,"talk"] call bis_fnc_taskSetType;
...
case "BIS_truck": {
	if (!(_taskExists)) then {
		[_taskID,"truck"] call bis_fnc_taskSetType;
