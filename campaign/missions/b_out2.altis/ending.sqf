...
_sometimeLater = ["\A3\Missions_F_EPA\video\B_out2_sometime_later.ogv"] spawn BIS_fnc_playVideo;
...
_actor kbAddTopic [ _topic, "\a3\Missions_F_EPA\kb\B_out2\b_out2_75_failed_invasion.bikb", ""];
...
_actor kbAddTopic [ _topic, "\a3\Missions_F_EPA\kb\B_out2\b_out2_75_failed_invasion_fake.bikb", ""];
[_prefix, _timekeys, _topic, 4.7, _actor] spawn BIS_HubBriefing_play;
...
[] spawn {
		...
		private _layer = "BIS_blackScreen" call BIS_fnc_rscLayer;
...
[["C_in1", 1], true, false, false] call BIS_fnc_endMission;
