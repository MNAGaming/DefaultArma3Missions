...
--------------------------------------------------------------------------------------------------*/
BIS_boardAltis setObjectTexture [0, "\A3\Missions_F_EPA\data\img\whiteboards\MapBoard_Altis_C_in1_CO.paa"];
BIS_boardStratis setObjectTexture [0, "\A3\Missions_F_EPA\data\img\whiteboards\MapBoard_Stratis_C_in1_CO.paa"];
...
[] spawn
{
	...
	waitUntil{missionNamespace getVariable ["BIS_HubIntro_finished",false]};
