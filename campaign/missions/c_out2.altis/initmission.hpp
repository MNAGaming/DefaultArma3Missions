...
[_dome, "Door_3_rot"] call BIS_fnc_DoorNoHandleOpen;
...
[] spawn {
	...
	if (!(BIS_skipStart)) then {
		...
		["\A3\Missions_F_EPA\video\C_out2_sometime_later.ogv", "STR_A3_B_in2_sometime_hours_later"] call BIS_fnc_quotations;
