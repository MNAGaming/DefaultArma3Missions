...
{_x hideObjectGlobal true} forEach (nearestTerrainObjects [[5044.002,16160.110,0],[],2.5]);
...
[_garage, 'Door_1_rot', 'Door_Handle_1_rot_1', 'Door_Handle_1_rot_2'] call BIS_fnc_DoorOpen;
[_garage, 'Door_2_rot', 'Door_Handle_2_rot_1', 'Door_Handle_2_rot_2'] call BIS_fnc_DoorOpen;

sleep 1;

["\A3\Missions_F_EPA\video\B_m06_quotation.ogv", "STR_A3_campaign_quote_32"] call BIS_fnc_quotations;
...
_addAmmo = [
	["30Rnd_65x39_caseless_green","6Rnd_45ACP_Cylinder","16Rnd_9x21_Mag","30Rnd_9x21_Mag","10Rnd_762x54_Mag","150Rnd_762x54_Box","1Rnd_HE_Grenade_shell","RPG32_F","HandGrenade","MiniGrenade"],
