...
BIS_player createDiarySubject [
 ...
 BIS_player createDiaryRecord [
  ...
  [
   ...
   "<img image = 'a3\Missions_F_EPA\data\img\Showcase_Fixed_Wings_briefing_CA.paa' width = '370' align='center'/>" + localize "STR_A3_Showcase_FixedWings_Showcase_Summary_text"
  ]
 ];
