...
if (true) then
{
	...
	_initCodes set [count _initCodes,[_this,"clearMagazineCargo this; clearWeaponCargo this; clearItemCargo this; this addWeaponCargo [""arifle_Katiba_F"",2]; this addMagazineCargo [""30Rnd_65x39_caseless_green"",30]; this addMagazineCargo [""150Rnd_762x54_Box"",5]; this addMagazineCargo [""1Rnd_HE_Grenade_shell"",20]; this addMagazineCargo [""HandGrenade"",20]; this addMagazineCargo [""SmokeShell"",20]; this addMagazineCargo [""UGL_FlareWhite_F"",20]; this addItemCargo [""Toolkit"",1]; this addItemCargo [""Medikit"",1]; this addItemCargo [""FirstAidKit"",12]"]];
};
