...
if (true) then
{
	...
	_this setUnitAbility 0.60000002;
	if (false) then {_group_2 selectLeader _this;};
	_initCodes set [count _initCodes,[_this,"this unlinkItem ""NVGoggles_opfor""; this setAmmo [(primaryWeapon this),6]; this removePrimaryWeaponItem ""acc_pointer_ir""; this removeMagazine ""10Rnd_762x54_Mag""; this removeItem ""FirstAidKit"""]];
};
