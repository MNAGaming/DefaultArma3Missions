...
[] spawn
{
	...
	private["_stage","_walkingUnits","_allUnits","_goggles","_t","_chemlightPoints","_weaponItems"];
	...
	{
		//remove flashlights
		_weaponItems = primaryWeaponItems _x;

		if ({_x == "acc_flashlight"} count _weaponItems > 0) then
		{
