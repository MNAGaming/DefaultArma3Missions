...
class Hubs
{
	...
	class DefHubA
	{
		...
		class IntroBriefing
		{
			...
			class AfterCutscene
			{
				...
				quote[] = {"\A3\Missions_F_EPA\video\B_Hub01_10_days_later.ogv","STR_A3_B_hub01_Few_days_later"};
			};
			...
			class Cutscene
			{
				...
				bikb 	= "\A3\Missions_F_EPA\kb\B_hub\b_hub_010_b_hub_briefing.bikb";
				offset 	= 1.0;
	...
	class B_hub01:DefHubB
	{
		...
		quote[] = {"\A3\Missions_F_EPA\video\B_Hub01_quotation.ogv","str_a3_campaign_quote_31"};
		...
		class HubIntro:HubIntro
		{
			...
			bikb 	   = "\a3\missions_F_EPA\kb\b_hub\b_hub_401_welcome_b_hub01.bikb";
			offset 	   = 0;
			last	   = 7.0;
	...
	class B_hub02:DefHubB
	{
		...
		*/
		...
		class HubIntro:HubIntro
		{
			...
			bikb 	   = "\a3\missions_F_EPA\kb\b_hub\b_hub_402_welcome_b_hub02.bikb";
			offset 	   = 0;
			last	   = 5.6;
	...
	class B_hub03:DefHubB
	{
		...
		class HubIntro:HubIntro
		{
			...
			bikb 	   = "\a3\missions_F_EPA\kb\b_hub\b_hub_403_welcome_b_hub03.bikb";
			offset 	   = 0;
			last	   = 2;
	...
	class C_in1:DefHubC
	{
		...
		kbWelcome = "";
		quote[] = {"\A3\Missions_F_EPA\video\C_in1_quotation.ogv","STR_A3_B_in2_12_hours_later"};
		...
		class 3dTweaks
		{
			_0[] = {-1,{2159.22,5609,0.603114},"OPEN","house",10,1,"missionNamespace getVariable ['BIS_HubBriefing_finished',false]"};
