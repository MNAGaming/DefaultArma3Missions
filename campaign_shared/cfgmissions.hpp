...
class Missions
{
	...
	class DefHubBriefingB:DefHubBriefingA
	{
		...
		{
			object = "BIS_map";
			texture = "\A3\Missions_F_EPA\data\img\papermaps\papermap_briefing_B_m01_CO.paa";
		};
	};
	...
	class B_m01:DefMission
	{
		...
		class HubBriefing:DefHubBriefingB_hub02
		{
			...
			class Cutscene:Cutscene
			{
				...
				bikb 	= "\a3\missions_F_EPA\kb\b_hub\b_hub_011_b_m01_briefing.bikb";
				offset 	= 0.1;
	...
	class B_m02_1:DefMission
	{
		...
		class HubBriefing:DefHubBriefingB_hub02
		{
			class Whiteboard:Whiteboard
			{
				texture = "\A3\Missions_F_EPA\data\img\papermaps\papermap_briefing_B_m02_CO.paa";
			};
			...
			class Cutscene:Cutscene
			{
				...
				bikb 	= "\a3\Missions_F_EPA\kb\B_hub\b_hub_012_b_m02_briefing.bikb";
				offset 	= 0.45;
	...
	class B_m03:DefMission
	{
		...
		class HubBriefing:DefHubBriefingB_hub02
		{
			class Whiteboard:Whiteboard
			{
				texture = "\A3\Missions_F_EPA\data\img\papermaps\papermap_briefing_B_m03_CO.paa";
			};
			...
			class Cutscene:Cutscene
			{
				...
				bikb 	= "\a3\Missions_F_EPA\kb\B_hub\b_hub_013_b_m03_briefing.bikb";
				offset 	= 0.0;
	...
	class B_m05:DefMission
	{
		...
		class HubBriefing:DefHubBriefingB_hub02
		{
			class Whiteboard:Whiteboard
			{
				texture = "\A3\Missions_F_EPA\data\img\papermaps\papermap_briefing_B_m05_CO.paa";
			};
			...
			class Cutscene:Cutscene
			{
				...
				bikb 	= "\a3\Missions_F_EPA\kb\B_hub\b_hub_015_b_m05_briefing.bikb";
				offset 	= -0.1;
	...
	class B_m06:DefMission
	{
		...
		class HubBriefing:DefHubBriefingB_hub01
		{
			class Whiteboard:Whiteboard
			{
				texture = "\A3\Missions_F_EPA\data\img\papermaps\papermap_briefing_B_m06_CO.paa";
			};
			...
			class Cutscene:Cutscene
			{
				...
				bikb 	= "\a3\Missions_F_EPA\kb\B_hub\b_hub_016_b_m06_briefing.bikb";
				offset 	= 0.0;
	...
	class B_out2:DefMission
	{
		...
		class HubBriefing:DefHubBriefingB_hub03
		{
			class Whiteboard:Whiteboard
			{
				texture = "\A3\Missions_F_EPA\data\img\papermaps\papermap_briefing_B_out2_CO.paa";
			};
			...
			class Cutscene:Cutscene
			{
				...
				bikb 	= "\a3\Missions_F_EPA\kb\B_hub\b_hub_017_b_out2_briefing.bikb";
				offset 	= 0.0;
	...
	class C_in2:DefMission
	{
		...
		class HubBriefing:DefHubBriefingA
		{
			...
			class Cutscene:Cutscene
			{
				...
				topic 	= "00_briefing";
				bikb 	= "\a3\Missions_F_EPA\kb\C_in1\c_in1_00_briefing.bikb";
				//offset 	= 0.55;
				offset 	= -1.45;
